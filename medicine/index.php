                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php foreach ($doctors as $doctor) { ?>
                            <p><a href="/medicine/doctor.php?id=<?=$doctor['ID']?>"><?= $doctor['NAME'] ?></a></p>
                        <?php } ?>
                        <p>
                            <a href="/medicine/add-doctor.php" class="ui-btn ui-btn-primary ui-btn-icon-add">
                                Добавить врача
                            </a>
                        </p>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php foreach ($procedures as $procedure) { ?>
                            <p>
                                <a href="/medicine/procedure.php?id=<?=$procedure['ID']?>">
                                    <?= $procedure['NAME'] ?>
                                </a>
                            </p>
                        <?php } ?>
                        <p>
                            <a href="/medicine/add-procedure.php" class="ui-btn ui-btn-primary ui-btn-icon-add">
                                Добавить процедуру
                            </a>
                        </p>
                    </div>
